    ...
    <div className={styles.container}>
      <nav className={styles.breadcrumb}>
        ...
        <span className={styles.breadcrumbSeparator}>
          <img src="/icons/arrow-right-black.svg" alt="" className={styles.breadcrumbIcon} />
        </span>
        <span className={styles.breadcrumbActive}>Products Details</span>
      </nav>

      <h1 className={styles.title}>Products or Services related to Dabur India Limited</h1>
